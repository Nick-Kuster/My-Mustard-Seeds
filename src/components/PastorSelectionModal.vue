  ...
  <q-dialog v-model="isOpen" persistent>
    <q-card style="min-width: 350px; max-width: 600px">
      <q-card-section class="row items-center">
        <div class="text-h6">Select Pastor</div>
        <q-space />
      ...
      <q-card-section>
        ...
        <div v-if="!showAddForm">
          <q-input v-model="searchTerm" label="Search pastors" dense class="q-mb-md" clearable>
          ...
          <q-list v-else separator>
            <q-item v-for="resource in filteredResources" :key="resource.id" clickable
              ...
              <q-item-section>
                ...
                <q-item-label caption>{{ resource.metadata.church }}</q-item-label>
              </q-item-section>
            </q-item>
          </q-list>

          <div class="text-center q-mt-md">
            <q-btn flat color="primary" label="Add New Pastor" @click="showAddForm = true" />
          </div>
        </div>
        ...
        <div v-else>
          <q-form @submit="addResource" class="q-gutter-md">
            ...
            <q-input v-model="newResource.church" label="Church *" :rules="[val => !!val || 'Church is required']" />
